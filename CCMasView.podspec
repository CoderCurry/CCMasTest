#
# Be sure to run `pod lib lint CCMasView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CCMasView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CCMasView.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'CCMasView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CCMasView' => ['CCMasView/Assets/*.png']
  # }
